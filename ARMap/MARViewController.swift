...
public protocol MARViewProtocol {
    var targetBearingDegrees: Double? {get set}
}

public typealias MARViewController = UIViewController & MARViewProtocol

public class MARViewControllerImpl: MARViewController {
    ...
    public override func viewDidLoad() {
        ...
        let compassHeightAngle = context.configuration.arViewCompassHeightAngleDegrees
        let compassMarkers = [
...
extension MARViewControllerImpl: ARSCNViewDelegate {
...
extension MARViewControllerImpl: ARCoachingOverlayViewDelegate {
